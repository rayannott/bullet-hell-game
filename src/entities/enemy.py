...
class TankEnemy(Enemy):
    ...
    def __init__(self, 
        ...
        super().__init__(
            ...
            health=ENEMY_DEFAULT_MAX_HEALTH * 3.2 + 100. * (self._player_level - 1),
...
class ArtilleryEnemy(Enemy):
    ...
    def __init__(self, 
        ...
        super().__init__(
            ...
            color=Color('#005c22'),
            speed=10.,
            health=ENEMY_DEFAULT_MAX_HEALTH * 2. + 50. * (self._player_level - 1),
...
class BossEnemy(Enemy):
    ...
    def __init__(self, 
        ...
        super().__init__(
            ...
            health=ENEMY_DEFAULT_MAX_HEALTH * 5.7 + 85. * (self._player_level - 1) * self.difficulty_mult**2,
