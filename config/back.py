...
# player
PLAYER_SIZE = 12.
PLAYER_DEFAULT_SPEED_RANGE = (100., 1200.) # min, max: depends on the distance to the gravity point
...
PLAYER_ULTIMATE_SPAWN_ENERGY_ORB_COST = 500
PLAYER_ULTIMATE_SPAWN_ENERGY_ORB_REQUIRED_ENERGY = 800
...
# oil spill
OIL_SPILL_SIZE = 80.
OIL_SPILL_LIFETIME = 15.
OIL_SPILL_SPEED_MULTIPLIER = 0.2
