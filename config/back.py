...
PLAYER_SPAWN_ENERGY_ORB_COST = 500.
PLAYER_SPAWN_ENERGY_ORB_REQUIRED_ENERGY = 800.

PLAYER_ULT_SHIELD_SIZE = 100.
PLAYER_ULT_SHIELD_DURATION = 5.
PLAYER_ULT_SHIELD_COOLDOWN = 20.
PLAYER_ULT_SHIELD_COST = 300.
