...
LIGHT_MAGENTA, NICER_GREEN, LIGHT_ORANGE = map(
    Color, (LIGHT_MAGENTA_HEX, NICER_GREEN_HEX, LIGHT_ORANGE_HEX)
)
...
class RulesWindow(pygame_gui.windows.UIMessageWindow):
    def __init__(self, manager: pygame_gui.UIManager, surface: Surface):
        ...
        super().__init__(
            rect=rect, manager=manager, window_title="Rules", html_message=TEXT
        )
